...
specimenData = as.data.frame(read.csv(paste(bombus_path, "raw_data/2022specimendata.csv", sep = ""), sep = ",", header = T))
specimenData2023 = as.data.frame(read.csv(paste(bombus_path, "raw_data/2023specimendata.csv", sep = ""), sep = ",", header = T, fill = TRUE))
samplePoints = as.data.frame(read.table(paste(bombus_path, "raw_data/allsamplepoints.csv", sep = ""), sep = ","))
colnames(samplePoints) = c("sample_pt", "gps","landowner","subsite")
sampleEffort = as.data.frame(read.csv(paste(bombus_path, "raw_data/2022sampledata.csv", sep = ""), sep = ","))
vegData = as.data.frame(read.csv(paste(bombus_path, "raw_data/2022vegetationdata.csv", sep = ""), sep = ","))
